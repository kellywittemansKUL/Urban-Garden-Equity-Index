...
```{r}
#Garden parcel map
Gardens <-st_read('./Input/Manchester Data/Manchester/Final_Gardens_BNG_fix_rowID.shp')

#Adminstrative parcel map
Parcels <- st_read('./Input/Manchester Data/Manchester/Parcel_boundaries_v2.shp')

#Land cover map
Landcover <- raster('./Input/Manchester Data/LandCoverData/GHIA_Final_GM_data.tif')
#eventueel accuraatere landcover toevoegen van 2x2m resolutie 
Landcover2 <- raster('./Input/Manchester Data/Classification_Manchester_thesis_1.5m_res_2017 (1)/CL_fin_study_area_extents.tif')

#Topographic Wetness Index (TWI)
TWI <- raster('./Input/TWI/TWI_Quinn_Manchester_filled_sinksPlanchon.tif')
...
LST <- raster('./Input/LST/LST_Manchester.tif')
LST[LST < 0] <- NA
...
Vulnerability <- st_read('./Input/gardens_vulnerability_quantile_scaled_Manchester.shp')

#Building dataset
Gbg <- st_read("./Buildings_Manchester.shp")

#Exposure dataset
exposure <- st_read("./Pop_density_NOMIS_Manchester.shp")
...
st_write(
  ...
  #writeOGR(BAF_tuinenkaart, dsn = "./Output" , layer = paste(a,b,"metrics_2015",sep = "."), driver= "ESRI Shapefile", overwrite_layer = TRUE)
